...
Download the latest release by clicking the [Releases](https://github.com/avalon60/ctk_theme_builder/releases/tag/v3.1.0) link on the right hand side, (don't click the <i><b>\<\> Code</b></i> button download for installations.)
