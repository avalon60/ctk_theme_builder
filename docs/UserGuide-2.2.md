...
It is strongly recommended that you take advantage of this feature. It serves as a more realistic rendering of your theme. When you think your theme is complete, or almost complete, launching this app provides the nearest thing to an acid test.
...
# What's New in CTk Theme Builder 2.2
There are several new features in 2.2:

* The ability to flip Light and Dark modes around for the currently selected theme, accessible via the _File_ menu;
* A new quality assurance app, which can be launched from the _File_ menu.
* A new _Merge Themes_ function, accessible via the _Tools_ menu.

NOTE: version 2.1 was a more modest release which introduced a new _Provenance_ option on the  _File_ menu. This allows you to view the details of when a theme was created, along with the authors name etc.
...
There are some issues which needed to be worked around, in respect of the *Preview Panel* operations. During release 2.2.0 of CTk Theme Builder, the latest release of CustomTkinter was 5.1.3. This had several associated issues:  
...
6. CTk 5.1.3: CTkCheckBox has no supporting configure option for checkmark_color [#1703](https://github.com/TomSchimansky/CustomTkinter/issues/1703)
